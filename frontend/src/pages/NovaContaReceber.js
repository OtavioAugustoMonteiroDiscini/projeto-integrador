...
const NovaContaReceber = () => {
  ...
  const createContaMutation = useMutation(
    (contaData) => contaReceberService.criar(contaData),
    {
      onSuccess: () => {
      ...
      onError: (error) => {
        toast.error(error.response?.data?.error || 'Erro ao registrar conta a receber');
      }
    }
  );
    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Registre uma nova conta a receber</p>
        </div>
      </div>
            ...
            <div className="card-body space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: Venda de produtos, Serviço prestado, etc."
                />
              ...
              <div className="card-body">
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">{formData.cliente || '-'}</span>
                  </div>
                  <div className="flex justify-between">
